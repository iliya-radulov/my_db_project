...
from parsers.parse_xy_v2 import parse_xy_file, find_peaks
from parsers.parse_vsm_final2 import parse_vsm_file
...
def plot_sem(file_path, figure=None):
    ...
    try:
        ...
        from parsers.parse_sem_fast import parse_sem_file
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print("Usage: python plot_xrd_v4_v2.py <file_path>")
        sys.exit(1)
